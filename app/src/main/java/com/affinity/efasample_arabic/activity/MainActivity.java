...
import com.affinity.efasample_arabic.Constants;
import com.affinity.efasample_arabic.RetrofitClient;
import com.affinity.efasample_arabic.adapter.BestSellCustomAdapter;
import com.affinity.efasample_arabic.adapter.CustomAdapter;
import com.affinity.efasample_arabic.adapter.Home_BannerAdapter;
import com.affinity.efasample_arabic.adapter.Home_CatAdapter;
import com.affinity.efasample_arabic.R;
import com.affinity.efasample_arabic.adapter.TrendCustomAdapter;
import com.affinity.efasample_arabic.models.HomeCatList;
import com.affinity.efasample_arabic.models.HomeCatlistDtls;
...
import static com.affinity.efasample_arabic.Constants.language;

public class MainActivity extends AppCompatActivity {

    //Featured
    int[] images = {R.drawable.banner4, R.drawable.banner3, R.drawable.banner2, R.drawable.banner4};
    String [] rate = {"SAR 32","SAR 29","SAR 34","SAR 31"};
    String [] name = {"تي شيرت نسائي","قميص رجل","تي شيرت نسائي","بليزر"};
    RecyclerView lView;
  ...
  //  int[] first_list_images = {R.drawable.accessories_outline, R.drawable.perfume_outline, R.drawable.soap_making_outline, R.drawable.gardening_outline,R.drawable.accessories_outline};
   // String [] catname = {"Accessories","Perfume","Soap Making","Gardening path","Accessories"};
    ...
    //Banners
    int[] first_listbanner_images = {R.drawable.banner4, R.drawable.banner3, R.drawable.banner2, R.drawable.banner4};
    ...
    String [] best_name =  {"تي شيرت نسائي","قميص رجل","تي شيرت نسائي","بليزر"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alertDialogBuilder.setTitle("تسجيل خروج");
                alertDialogBuilder.setMessage("هل أنت متأكد أنك تريد تسجيل الخروج?");
                ...
                alertDialogBuilder.setNegativeButton("يلغي", new DialogInterface.OnClickListener() {
                    @Override
...
/*
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.cart:
                     ...
                     case R.id.terms_condition:
                         Intent terms = new Intent(getApplicationContext(), TermsAndConditionActivity.class);
                         startActivity(terms);
                        drawerLayout.closeDrawers();
                        break;
                  ...
                  case R.id.privacy_policy:
                        Intent privacy = new Intent(getApplicationContext(), Privacy_policy.class);
    ...
    private void homeCatList() {
        progress.show();
        Call<HomeCatList> call = RetrofitClient.getApiService().getHomeCat("ar");
                ...
                if (data.status.equalsIgnoreCase("true")) {
                    ...
                    homeCatListview.addOnItemTouchListener(new MainActivity.RecyclerTouchListener(MainActivity.this,
                        ...
                        public void onClick(View view, final int position) {
                            Intent intet = new Intent(MainActivity.this,CategoryActivity.class);
                            startActivity(intet);
                        }
                        @Override
